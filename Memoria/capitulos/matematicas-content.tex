...
Para desarrollar esta sección se han utlizado las siguientes referencias bibliográficas:\cite{clustering-2}\cite{Bib-5}. \newline%clustering-2 %Bib-5 \newline
...
\subsubsection{Medidas de disimilaridad entre individuos}   % clustering-1, clustering-2, Bib-1, Bib-6, Bib-5
