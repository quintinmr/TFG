...
de clusters distintos sean bastante diferentes \cite{Bib-1, Bib-2}.\newline
...
\begin{ejemplo}
    ...
    \begin{figure}[h]
        ...
        \caption{Método de Elbow aplicado al ejemplo del método k-means[elaboración propia].}
    \end{figure}
...
\begin{ejemplo}
    ...
    \begin{figure}[h]
        ...
        \caption{Método de la Silueta aplicado al ejemplo del método k-means[elaboración propia].}
    \end{figure}
